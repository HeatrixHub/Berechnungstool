...
from ...services.tab1_berechnung import (
    validate_inputs,
    perform_calculation,
    get_k_values_for_layers,
)
from app.core import isolierungen_db as insulation_logic
...
class BerechnungTab:
    ...
    def _get_insulation_names(self) -> List[str]:
        from app.core.isolierungen_db.logic import get_all_insulations
