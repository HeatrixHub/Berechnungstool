...
from .tab5_zuschnitt_logic import Placement, color_for, pack_plates
...
class ZuschnittTab:
    ...
    def run_optimization(self) -> None:
        try:
            ...
            if not plates:
                return
            placements, summary, total_cost, total_bins = pack_plates(plates, kerf)
