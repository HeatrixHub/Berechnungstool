...
from app.ui.global_tabs.isolierungen_db.tab import IsolierungenTab
from app.ui.global_tabs.report.tab import ReportTab
from app.ui.plugins.base import AppContext, Plugin
from app.ui.plugins.manager import PluginManagerDialog
from app.ui.projects.tab import ProjectsTab
...
def main() -> None:
    ...
    ReportTab(notebook, project_store, plugins, tab_name="Bericht")
